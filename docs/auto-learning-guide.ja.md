...
- 複数のエッジ（クライアント）で学習した結果を中央で統合する分散学習アーキテクチャについては、[Federated Learning（連合学習）](./13-feedback-loop.ja.md) をご参照ください。
- ベースとなるTrainerの数学的背景や種類については [Trainers](./7-trainers.ja.md) をご参照ください。
